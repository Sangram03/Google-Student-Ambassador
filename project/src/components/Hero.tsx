    ...
    <section className="pt-16 bg-gradient-to-br from-blue-50 via-white to-purple-50 min-h-screen flex items-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div>
            <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-100 to-purple-100 text-blue-700 px-4 py-2 rounded-full text-sm font-medium mb-6 shadow-sm">
              <Star className="w-4 h-4" />
              <span>🚀 Limited Spots for Our College</span>
            </div>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
              ...
              <br /> <span className="underline decoration-purple-500">Our Campus</span>
            </h1>
            
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              🌟 Imagine being recognized as a <b>Google Student Ambassador</b> in our college!  
              Join the league of <b>50+ students</b> already accepted and become part of an exclusive community of  
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              ...
              >
                <span className="text-lg font-semibold">🔥 Apply Now & Represent Our College</span>
            ...
            <div className="flex items-center space-x-8">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-600">🎓 50+ Students Already Onboard</span>
              </div>
              <div className="flex items-center space-x-2">
